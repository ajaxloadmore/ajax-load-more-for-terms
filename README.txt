...
Plugin URI: https://connekthq.com/plugins/ajax-load-more/extensions/terms/
...
Ajax Load More extension that adds compatibility for infinite scrolling WordPress terms using [term_query](https://developer.wordpress.org/reference/classes/wp_term_query/).
